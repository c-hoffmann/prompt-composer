...
const I18N = {
  de: {
    "app.title": "Prompt Composer",
    "app.subtitle": "Modulare KI-Prompts",
    ...
    "common.or": "oder",
    "step.type": "Projekttyp",
    "step.phase": "Phase",
    "step.questions": "Details",
    "step.configure": "Konfigurieren",
    "step1.title": "Worum geht's?",
    "step1.desc": "Wähle den Projekttyp, mit dem du arbeitest.",
    "step2.title": "Was möchtest du tun?",
    "step2.desc": "Wähle den passenden Schritt.",
    "step3.title": "Kurze Rückfrage",
    "step3.desc": "Hilft, den Prompt zu optimieren.",
    "step4.title": "Prompt konfigurieren",
    "config.variables": "Variablen",
    "config.sections": "Abschnitte",
    "config.optimize_for": "Wonach optimieren?",
    "config.modifiers": "Modifikatoren",
    "config.extra": "Zusätzliche Anforderungen",
    "config.extra_ph": "Projektspezifische Ergänzungen…",
    "preview.title": "Vorschau",
    "preview.empty":
      "Wähle Projekttyp und Phase — dann siehst du hier den zusammengebauten Prompt.",
    "preview.copy_step": "Schritt kopieren",
    "preview.copy_all": "Alles kopieren",
    "favs.title": "Favoriten",
    "favs.empty": "Noch keine Favoriten",
    "favs.save": "Als Favorit speichern",
    "favs.name_ph": "Name für diesen Favoriten…",
    "hist.title": "Zuletzt verwendet",
    "hist.empty": "Noch keine Prompts generiert",
    "settings.title": "Einstellungen",
    "settings.ui_lang": "Oberflächensprache",
    "settings.out_lang": "KI antwortet auf",
    "settings.country": "Land des Nutzers",
    "settings.theme": "Design",
    "settings.theme_light": "Hell",
    "settings.theme_dark": "Dunkel",
    "settings.theme_neon": "Neon",
    "settings.theme_hc": "♿ Kontrast",
    "settings.variables": "Globale Variablen",
    "settings.data": "Daten",
    "settings.reset_confirm":
      "Alle Einstellungen und gespeicherten Daten zurücksetzen?",
    "output_lang.block":
      "Provide all explanations, comments, and prose in {{lang}}. Keep all code, variable names, CLI commands, and technical identifiers in English. Adapt examples and references to be relevant for {{country}} where applicable.",
    "changelog.title": "Neue Version",
    "changelog.updated": "wurde aktualisiert auf Version",
    "quality.title": "Prompt-Qualität",
    "quality.no_role":
      "Keine Rolle definiert — eine Rollenzuweisung liefert gezielteren Output.",
    "quality.no_format": "Kein Ausgabeformat spezifiziert.",
    "quality.too_short": "Sehr kurzer Prompt für eine komplexe Aufgabe.",
    "quality.too_vague": "Enthält vage Formulierungen.",
    "quality.multi_task": "Enthält mehrere separate Aufgaben.",
    "quality.good": "Prompt sieht gut strukturiert aus.",
    "plugins.title": "Prompt-Pakete",
    "plugins.installed": "Installiert",
    "plugins.none": "Keine Pakete installiert.",
    "plugins.import": "Paket importieren",
    "plugins.export": "Paket exportieren",
    "plugins.remove": "Entfernen",
    "plugins.create": "Neuen Projekttyp erstellen",
    "plugins.name": "Name",
    "plugins.name_en": "Name (EN)",
    "plugins.icon": "Icon (Emoji)",
    "plugins.desc": "Beschreibung",
    "plugins.desc_en": "Beschreibung (EN)",
    "plugins.author": "Autor",
    "plugins.update": "Aktualisieren",
    "plugins.conflict": "Namenskonflikt",
    "plugins.confirm_remove": "Dieses Paket wirklich entfernen?",
    "plugins.imported": "Paket importiert!",
    "plugins.invalid": "Ungültiges Paket-Format.",
    "plugins.phases": "Phasen",
    "plugins.add_phase": "Phase hinzufügen",
    "plugins.phase_name": "Phasenname",
    "plugins.phase_name_en": "Phasenname (EN)",
    "plugins.phase_icon": "Icon",
    "plugins.prompt_template": "Prompt-Vorlage",
    "plugins.save": "Speichern",
    "config.fields": "Details ausfüllen",
    "config.show_advanced": "Erweiterte Optionen anzeigen",
    "config.hide_advanced": "Erweiterte Optionen ausblenden",
    "home.welcome": "Willkommen",
    "home.quick_start":
      "Schnellstart: Wähle einen Projekttyp oder nutze einen Favoriten.",
  },
  en: {
    "app.title": "Prompt Composer",
    "app.subtitle": "Modular AI Prompts",
    "common.copy": "Copy",
    ...
    "common.or": "or",
    "step.type": "Project Type",
    "step.phase": "Phase",
    "step.questions": "Details",
    "step.configure": "Configure",
    "step1.title": "What are you working on?",
    "step1.desc": "Choose the type of project.",
    "step2.title": "What do you want to do?",
    "step2.desc": "Choose the right step.",
    "step3.title": "Quick question",
    "step3.desc": "Helps optimize the prompt.",
    "step4.title": "Configure prompt",
    "config.variables": "Variables",
    "config.sections": "Sections",
    "config.optimize_for": "Optimize for?",
    "config.modifiers": "Modifiers",
    "config.extra": "Additional requirements",
    "config.extra_ph": "Project-specific additions…",
    "preview.title": "Preview",
    "preview.empty":
      "Choose a project type and phase to see the assembled prompt here.",
    "preview.copy_step": "Copy step",
    "preview.copy_all": "Copy all",
    "favs.title": "Favorites",
    "favs.empty": "No favorites yet",
    "favs.save": "Save as favorite",
    "favs.name_ph": "Name for this favorite…",
    "hist.title": "Recently used",
    "hist.empty": "No prompts generated yet",
    "settings.title": "Settings",
    "settings.ui_lang": "Interface language",
    "settings.out_lang": "AI responds in",
    ...
    "settings.data": "Data",
    "settings.reset_confirm": "Reset all settings and saved data?",
    "output_lang.block":
      "Provide all explanations, comments, and prose in {{lang}}. Keep all code, variable names, CLI commands, and technical identifiers in English. Adapt examples and references to be relevant for {{country}} where applicable.",
    "changelog.title": "New Version",
    "changelog.updated": "has been updated to version",
    "quality.title": "Prompt Quality",
    "quality.no_role":
      "No role defined — a role assignment produces more targeted output.",
    "quality.no_format": "No output format specified.",
    "quality.too_short": "Very short prompt for a complex task.",
    "quality.too_vague": "Contains vague wording.",
    "quality.multi_task": "Contains multiple separate tasks.",
    "quality.good": "Prompt looks well-structured.",
    "plugins.title": "Prompt Packages",
    "plugins.installed": "Installed",
    "plugins.none": "No packages installed.",
    "plugins.import": "Import Package",
    "plugins.export": "Export Package",
    "plugins.remove": "Remove",
    "plugins.create": "Create New Project Type",
    "plugins.name": "Name",
    "plugins.name_en": "Name (EN)",
    "plugins.icon": "Icon (Emoji)",
    "plugins.desc": "Description",
    "plugins.desc_en": "Description (EN)",
    "plugins.author": "Author",
    "plugins.update": "Update",
    "plugins.conflict": "Name Conflict",
    "plugins.confirm_remove": "Really remove this package?",
    "plugins.imported": "Package imported!",
    "plugins.invalid": "Invalid package format.",
    "plugins.phases": "Phases",
    "plugins.add_phase": "Add Phase",
    "plugins.phase_name": "Phase Name",
    "plugins.phase_name_en": "Phase Name (EN)",
    "plugins.phase_icon": "Icon",
    "plugins.prompt_template": "Prompt Template",
    "plugins.save": "Save",
    "config.fields": "Fill in details",
    "config.show_advanced": "Show advanced options",
    "config.hide_advanced": "Hide advanced options",
    "home.welcome": "Welcome",
    "home.quick_start": "Quick start: Choose a project type or use a favorite.",
  },
};
...
const VARIABLE_HINTS = {
  system: {
    ...
    hint: {
      de: "Betriebssystem, Shell, Paketmanager, Hardware.",
      en: "OS, shell, package manager, hardware.",
    },
  ...
  dataset_description: {
    ...
    hint: {
      de: "Name, Spalten, Datentypen, Größe.",
      en: "Name, columns, data types, size.",
    },
  ...
  target: {
    ...
    hint: {
      de: "Variable für Vorhersage/Analyse.",
      en: "Variable to predict or analyze.",
    },
    example: "revenue",
  },
  analysis_type: {
  ...
  audience: {
    ...
    hint: {
      de: "Für wen? Beeinflusst Detailtiefe.",
      en: "For whom? Affects detail level.",
    },
...
const FIELD_LABELS_DE = {
  ...
  Context: "Kontext",
  "Received message": "Erhaltene Nachricht",
  "My goal": "Mein Ziel",
  Format: "Format",
  Columns: "Spalten",
  Domain: "Fachgebiet",
  ...
  "Current Setup": "Aktuelle Einrichtung",
  Problem: "Problem",
  Constraints: "Einschränkungen",
  From: "Von",
  Data: "Daten",
  "Downtime tolerance": "Ausfalltoleranz",
  Symptoms: "Symptome",
  "Logs/Output": "Logs/Ausgabe",
  "Recent changes": "Letzte Änderungen",
  Consumers: "Nutzer/Konsumenten",
  Entities: "Entitäten",
  ...
  "Current prompt": "Aktueller Prompt",
  Prompt: "Prompt",
...
const FIELD_HINTS_DE = {
  ...
  "inform, persuade, entertain, instruct?":
    "informieren, überzeugen, unterhalten, anleiten?",
  "formal, factual, casual, scientific?":
    "formell, sachlich, locker, wissenschaftlich?",
  "approximate word count or page count": "ungefähre Wort- oder Seitenzahl",
  "structure, sources, style": "Struktur, Quellen, Stil",
  "relationship to recipient: colleague, supervisor, client, ...":
    "Beziehung zum Empfänger: Kollege, Vorgesetzter, Kunde, ...",
  "why am I writing?": "Warum schreibe ich?",
  "what should the recipient do/think/feel?":
    "Was soll der Empfänger tun/denken/fühlen?",
  "formal, friendly, direct, diplomatic?":
    "formell, freundlich, direkt, diplomatisch?",
  ...
  "describe what needs to be set up":
    "beschreiben, was eingerichtet werden muss",
  "describe what exists": "beschreiben, was bereits vorhanden ist",
  "what needs improvement - cost, performance, reliability?":
    "Was muss verbessert werden — Kosten, Performance, Zuverlässigkeit?",
  "budget, downtime tolerance, compliance":
    "Budget, Ausfalltoleranz, Compliance",
  "current provider/version/setup": "aktueller Anbieter/Version/Setup",
  "target provider/version/setup": "Ziel-Anbieter/Version/Setup",
  "what data needs to be migrated, volume, format":
    "Welche Daten migriert werden müssen, Volumen, Format",
  "zero-downtime required? maintenance window?":
    "Zero-Downtime erforderlich? Wartungsfenster?",
  ...
  "what changed before the issue started?":
    "Was hat sich geändert, bevor das Problem begann?",
  ...
  "list main entities and their relationships":
    "Haupt-Entitäten und ihre Beziehungen auflisten",
  ...
  "budget, timeline, technology, team size":
    "Budget, Zeitrahmen, Technologie, Teamgröße",
  ...
  "what should this AI agent/chatbot do?":
    "Was soll dieser KI-Agent/Chatbot tun?",
...
const TYPES = [
  {
    ...
    tk: "Skript",
    te: "Script",
    dk: "Shell, Python, einzelne Skripte",
    de: "Shell, Python, single scripts",
  },
  {
    id: "repo",
    icon: "📦",
    tk: "Repo / Projekt",
    te: "Repo / Project",
    dk: "Git-Repository, Multi-File",
    de: "Git repository, multi-file",
  },
  {
    id: "text",
    icon: "📝",
    tk: "Text / Dokument",
    te: "Text / Document",
    dk: "Artikel, Bericht, Dokumentation",
    de: "Article, report, documentation",
  },
  {
    id: "mail",
    icon: "✉️",
    tk: "E-Mail / Nachricht",
    te: "Email / Message",
    dk: "Geschäftlich oder persönlich",
    de: "Business or personal",
  },
  {
    id: "data",
    icon: "📊",
    tk: "Daten & Analyse",
    te: "Data & Analysis",
    dk: "CSV, SQL, Statistik, Visualisierung",
    de: "CSV, SQL, statistics, visualization",
  },
  {
    id: "devops",
    icon: "🔧",
    tk: "DevOps & Infra",
    te: "DevOps & Infra",
    dk: "Docker, CI/CD, Terraform, Cloud",
    de: "Docker, CI/CD, Terraform, Cloud",
  },
  {
    id: "api",
    icon: "🔌",
    tk: "API & Schema",
    te: "API & Schema",
    dk: "REST, GraphQL, Datenbank-Schema",
    de: "REST, GraphQL, database schema",
  },
  {
    id: "learn",
    icon: "🎓",
    tk: "Lernen & Erklärung",
    te: "Learn & Explain",
    dk: "Tutorials, Vergleiche, Cheatsheets",
    de: "Tutorials, comparisons, cheatsheets",
  },
  {
    id: "plan",
    icon: "🗺️",
    tk: "Planung & Architektur",
    te: "Planning & Architecture",
    dk: "Brainstorm, Konzept, ADR, Diagramme",
    de: "Brainstorm, concept, ADR, diagrams",
  },
  {
    id: "prompt",
    icon: "🧠",
    tk: "Prompt Engineering",
    te: "Prompt Engineering",
    dk: "Prompts schreiben, prüfen, optimieren",
    de: "Write, review, optimize prompts",
  },
  {
    id: "other",
    icon: "⚙️",
  ...
  script: [
    {
      ...
      tk: "Neues Skript",
      te: "New Script",
      dk: "Von Grund auf planen",
      de: "Plan from scratch",
    },
    {
      id: "optimize",
      icon: "⚡",
    ...
    },
    {
      ...
      tk: "Prüfen",
      te: "Review",
      dk: "Auf Korrektheit prüfen",
      de: "Check for correctness",
    },
    {
      id: "research",
      icon: "🔬",
    ...
    },
    {
      ...
      tk: "Bug fixen",
      te: "Fix Bug",
      dk: "Konkretes Problem lösen",
      de: "Fix a specific problem",
    },
  ],
  repo: [
    {
      ...
      tk: "Neues Projekt",
      te: "New Project",
      dk: "Anforderungen, Research, Prototyp",
      de: "Requirements, research, prototype",
    },
    {
      id: "optimize",
      icon: "⚡",
      tk: "Optimieren",
      te: "Optimize",
      dk: "Bestehendes Repo verbessern",
      de: "Improve existing repo",
    },
    {
      id: "review",
      icon: "🔍",
      tk: "Prüfen",
      te: "Review",
      dk: "Auf Korrektheit und Sicherheit",
      de: "Check correctness and security",
    },
    {
      id: "research",
      icon: "🔬",
    ...
    },
    {
      ...
      tk: "Setup-Skript",
      te: "Setup Script",
      dk: "Idempotentes Setup mit Rollback",
      de: "Idempotent setup with rollback",
    },
  ],
  text: [
    {
      id: "write",
      icon: "✏️",
      tk: "Neuen Text schreiben",
      te: "Write New Text",
      dk: "Von Null starten",
      de: "Start from scratch",
    },
    {
      id: "optimize",
      icon: "⚡",
      tk: "Überarbeiten",
      te: "Revise",
      dk: "Bestehenden Text verbessern",
      de: "Improve existing text",
    },
    {
      id: "review",
      icon: "🔍",
      tk: "Lektorat",
      te: "Proofread",
      dk: "Qualität und Konsistenz",
      de: "Quality and consistency",
    },
    {
      id: "research",
      icon: "🔬",
      tk: "Recherchieren",
      te: "Research",
      dk: "Deep Research zum Thema",
      de: "Deep research on the topic",
    },
  ],
  mail: [
    {
      ...
      tk: "Neue Nachricht",
      te: "New Message",
      dk: "Von Null formulieren",
      de: "Compose from scratch",
    },
    {
      id: "optimize",
      icon: "⚡",
      tk: "Überarbeiten",
      te: "Revise",
      dk: "Ton und Wirkung verbessern",
      de: "Improve tone and impact",
    },
    {
      id: "reply",
      icon: "↩️",
      tk: "Antwort formulieren",
      te: "Compose Reply",
      dk: "Auf erhaltene Nachricht reagieren",
      de: "Reply to a received message",
    },
  ],
  data: [
    {
      ...
      tk: "Daten erkunden",
      te: "Explore Data",
      dk: "EDA, Verteilungen, Muster",
      de: "EDA, distributions, patterns",
    },
    {
      id: "clean",
      icon: "🧹",
      tk: "Bereinigen",
      te: "Clean",
      dk: "Fehlende Werte, Duplikate, Formate",
      de: "Missing values, duplicates, formats",
    },
    {
      id: "analyze",
      icon: "📈",
      tk: "Analysieren",
      te: "Analyze",
      dk: "Statistik, Modellierung",
      de: "Statistics, modeling",
    },
    {
      id: "visualize",
      icon: "📊",
      tk: "Visualisieren",
      te: "Visualize",
      dk: "Charts, Dashboards",
      de: "Charts, dashboards",
    },
    {
      id: "summarize",
      icon: "📋",
      tk: "Zusammenfassen",
      te: "Summarize",
      dk: "Ergebnisse für Stakeholder",
      de: "Results for stakeholders",
    },
  ],
  devops: [
    {
      ...
      tk: "Erstellen",
      te: "Create",
      dk: "Neue Infrastruktur aufsetzen",
      de: "Set up new infrastructure",
    },
    {
      id: "secure",
      icon: "🔒",
      tk: "Absichern",
      te: "Secure",
      dk: "Security-Audit, Hardening",
      de: "Security audit, hardening",
    },
    {
      id: "debug",
      icon: "🐛",
    ...
    },
    {
      ...
      tk: "Optimieren",
      te: "Optimize",
      dk: "Performance, Kosten",
      de: "Performance, costs",
    },
    {
      id: "migrate",
      icon: "🔄",
      tk: "Migrieren",
      te: "Migrate",
      dk: "Provider/Version wechseln",
      de: "Switch provider/version",
    },
  ],
  api: [
    {
      ...
      tk: "Entwerfen",
      te: "Design",
      dk: "API-Architektur und Endpoints",
      de: "API architecture and endpoints",
    },
    {
      id: "spec",
      icon: "📄",
      tk: "Spezifizieren",
      te: "Specify",
      dk: "OpenAPI/Swagger generieren",
      de: "Generate OpenAPI/Swagger",
    },
    {
      id: "schema",
      icon: "🗄️",
      tk: "DB-Schema",
      te: "DB Schema",
      dk: "Datenbank-Schema entwerfen",
      de: "Design database schema",
    },
    {
      id: "doc",
      icon: "📖",
      tk: "Dokumentieren",
      te: "Document",
      dk: "API-Dokumentation erstellen",
      de: "Create API documentation",
    },
    {
      id: "review",
      icon: "🔍",
      tk: "Prüfen",
      te: "Review",
      dk: "Schema/API reviewen",
      de: "Review schema/API",
    },
  ],
  learn: [
    {
      ...
      tk: "Erklären",
      te: "Explain",
      dk: "Konzept verständlich erklären",
      de: "Explain a concept clearly",
    },
    {
      id: "tutorial",
      icon: "📚",
      tk: "Tutorial",
      te: "Tutorial",
      dk: "Schritt-für-Schritt Anleitung",
    ...
    },
    {
      ...
      tk: "Vergleichen",
      te: "Compare",
      dk: "Technologien/Ansätze vergleichen",
      de: "Compare technologies/approaches",
    },
    {
      id: "cheatsheet",
      icon: "📋",
      tk: "Cheatsheet",
      te: "Cheatsheet",
      dk: "Kompakte Referenz erstellen",
      de: "Create compact reference",
    },
    {
      id: "exercise",
      icon: "🏋️",
      tk: "Übung",
      te: "Exercise",
      dk: "Übungsaufgaben generieren",
      de: "Generate practice exercises",
    },
  ],
  plan: [
    {
    ...
    },
    {
      id: "concept",
      icon: "📐",
      tk: "Konzept erstellen",
      te: "Create Concept",
      dk: "Struktur und Architektur",
      de: "Structure and architecture",
    },
    {
      id: "decision",
      icon: "⚖️",
      tk: "Entscheidung (ADR)",
      te: "Decision (ADR)",
      dk: "Trade-offs evaluieren",
      de: "Evaluate trade-offs",
    },
    {
      id: "diagram",
      icon: "🗺️",
      tk: "Diagramm",
      te: "Diagram",
      dk: "Mermaid, PlantUML, C4",
      de: "Mermaid, PlantUML, C4",
    },
    {
      id: "project",
      icon: "📋",
  ...
  prompt: [
    {
      ...
      tk: "Prompt schreiben",
      te: "Write Prompt",
      dk: "Aus Aufgabenbeschreibung",
      de: "From task description",
    },
    {
      id: "optimize",
      icon: "⚡",
      tk: "Prompt optimieren",
      te: "Optimize Prompt",
      dk: "Bestehenden Prompt verbessern",
      de: "Improve existing prompt",
    },
    {
      id: "review",
      icon: "🔍",
      tk: "Prompt prüfen",
      te: "Review Prompt",
      dk: "12-Dimensionen-Checkliste",
      de: "12-dimension checklist",
    },
    {
      id: "system",
      icon: "🤖",
      tk: "System Prompt",
      te: "System Prompt",
      dk: "Für Chatbots/Agents",
      de: "For chatbots/agents",
    },
  ],
  other: [
    {
...
const QUESTIONS = {
  "script:optimize": {
    q: { dk: "Wonach optimieren?", de: "Optimize for?" },
    multi: true,
    opts: [
      { id: "readability", lk: "Lesbarkeit", le: "Readability" },
      { id: "simplify", lk: "Vereinfachung", le: "Simplification" },
      { id: "ux", lk: "User Experience", le: "User Experience" },
      { id: "security", lk: "Sicherheit", le: "Security" },
      { id: "structure", lk: "Struktur", le: "Structure" },
      { id: "performance", lk: "Performance", le: "Performance" },
    ],
  },
  "repo:optimize": {
    q: { dk: "Wonach optimieren?", de: "Optimize for?" },
    ...
    opts: [
      ...
      { id: "ux", lk: "User Experience", le: "User Experience" },
      { id: "security", lk: "Sicherheit", le: "Security" },
      { id: "structure", lk: "Struktur / Aufteilung", le: "Structure / Split" },
      { id: "docs", lk: "Dokumentation", le: "Documentation" },
    ],
  },
  "text:optimize": {
    q: { dk: "Wonach überarbeiten?", de: "Revise for?" },
    multi: true,
    opts: [
      { id: "clarity", lk: "Klarheit", le: "Clarity" },
      { id: "brevity", lk: "Kürze", le: "Brevity" },
      { id: "tone", lk: "Ton & Stil", le: "Tone & Style" },
      { id: "grammar", lk: "Grammatik", le: "Grammar" },
    ],
  },
  ...
  "text:write": {
    q: { dk: "Was für ein Text?", de: "What kind of text?" },
    multi: false,
    opts: [
      { id: "article", lk: "Artikel / Blogpost", le: "Article / Blog post" },
      { id: "report", lk: "Bericht", le: "Report" },
      { id: "docs", lk: "Dokumentation", le: "Documentation" },
      { id: "creative", lk: "Kreativ / Erzählung", le: "Creative / Narrative" },
    ],
  },
  "data:analyze": {
    q: { dk: "Art der Analyse?", de: "Type of analysis?" },
    multi: false,
    varKey: "analysis_type",
    opts: [
      { id: "eda", lk: "Explorative Analyse", le: "Exploratory Analysis" },
      { id: "regression", lk: "Regression", le: "Regression" },
      { id: "classification", lk: "Klassifikation", le: "Classification" },
      { id: "clustering", lk: "Clustering", le: "Clustering" },
      { id: "timeseries", lk: "Zeitreihe", le: "Time Series" },
    ],
  },
  "devops:create": {
    q: { dk: "Was erstellen?", de: "What to create?" },
    multi: false,
    varKey: "devops_tool",
    opts: [
      { id: "docker", lk: "Dockerfile / Compose", le: "Dockerfile / Compose" },
      { id: "terraform", lk: "Terraform / IaC", le: "Terraform / IaC" },
      { id: "cicd", lk: "CI/CD Pipeline", le: "CI/CD Pipeline" },
      { id: "k8s", lk: "Kubernetes", le: "Kubernetes" },
      {
        id: "monitoring",
        lk: "Monitoring / Alerting",
        le: "Monitoring / Alerting",
      },
    ],
  },
  "api:design": {
    q: { dk: "API-Stil?", de: "API style?" },
    multi: false,
    varKey: "api_style",
    opts: [
      { id: "rest", lk: "REST", le: "REST" },
      { id: "graphql", lk: "GraphQL", le: "GraphQL" },
      { id: "grpc", lk: "gRPC", le: "gRPC" },
    ],
  },
  "plan:brainstorm": {
    q: { dk: "Brainstorm-Methode?", de: "Brainstorm method?" },
    multi: false,
    varKey: "brainstorm_method",
    opts: [
      { id: "free", lk: "Freies Brainstorming", le: "Free Brainstorming" },
      { id: "scamper", lk: "SCAMPER", le: "SCAMPER" },
      { id: "sixhats", lk: "Six Thinking Hats", le: "Six Thinking Hats" },
      {
        id: "reverse",
        lk: "Reverse Brainstorming",
        le: "Reverse Brainstorming",
      },
    ],
  },
};
...
- The repo must be professional and production-ready.
  ...
  opt_readability:
    "- Are there ways to make the code more readable without bloating it?\n- Are naming conventions consistent throughout (files, variables, functions)?",
  opt_simplify:
    "- Are there ways to meaningfully simplify without losing important functionality?\n- Are there dead code paths, redundant logic, or implicit dependencies?",
  opt_ux:
    "- Are there ways to optimize user experience without bloating the project?\n- Ensure there is a clear, concise description and prerequisites (OS, packages, versions).",
  opt_security:
    "- Check for hardcoded credentials/secrets, insecure defaults, missing input validation.\n- Are there code paths that could delete, overwrite, or corrupt data?",
  opt_structure:
    "- Does it make sense to split some files into multiple files?\n- Should any files be merged?\n- Feel free to make large restructuring changes if beneficial.",
  opt_performance:
    "- Are there performance bottlenecks that can be resolved without adding complexity?\n- Are there unnecessary computations or redundant I/O operations?",
  opt_docs:
    "- Is the documentation complete, accurate, and up-to-date?\n- Does a README exist with clear setup instructions?",
  opt_text_clarity:
...
<task>Review the {{project_type}} using EACH of the following methods. Document what was checked and what was found for each method.</task>`,
  ...
  review_m1:
    "**Method 1 — Control Flow Trace:** Trace EVERY path through error handling functions. Play through all error combinations (each step OK vs. FAIL). Can any scenario produce an inconsistent state or data loss?",
  review_m2:
    "**Method 2 — Data Flow Analysis:** Trace every value written to a variable and later used as a command or path. Can any of these values be empty, contain spaces, or point to an unexpected filesystem location?",
  review_m3:
    "**Method 3 — Partial State Analysis:** What happens if the script aborts MID-FUNCTION (network error, user abort, power failure)? What does the NEXT run see? Does it take the correct code path?",
  review_m4:
    "**Method 4 — Language Standard Analysis:** Does error handling behave as expected in all calling contexts? Are there implicit context switches where errors are silently swallowed or variable changes are lost?",
  review_m5:
    "**Method 5 — Quoting/Encoding Audit:** Find EVERY place where a variable is used without proper escaping in a command. Can paths with spaces, special characters, or Unicode cause errors?",
  review_m6:
    "**Method 6 — Platform Audit:** Are there commands, flags, or libraries that don't exist or behave differently on the target platform?",
  review_suffix:
    "<output_format>ONE table with columns: Method, What was checked, Finding, Severity, Fix. Then: implement all fixes. Add a comment to each fix describing the previous problem and the reason for the change.</output_format>",
...
<task>The {{project_type}} MUST address each of the following points. Write a code comment for each explaining HOW it is addressed and WHY the alternative would be dangerous.</task>`,
  sec_paths:
    "**Path Safety:** Can the script accidentally execute a system binary if a variable is empty or a path cannot be resolved? Are all path variables properly escaped?",
  sec_files:
    "**File Safety:** Can the script corrupt a user's configuration file (duplicate entries, broken syntax)? Can rollback operations lose data?",
  sec_errors:
    "**Error Handling:** Does error handling work correctly in all contexts (functions, subshells, pipes)? Are error messages never misleading?",
  sec_platform:
    "**Platform Compatibility:** Are there commands or flags that don't exist or behave differently on the target platform?",
  sec_idempotency:
    "**Idempotency:** Can the script cause damage when run repeatedly? Are already-installed components correctly detected and skipped?",
  sec_smoke:
    "**Smoke Tests:** Do the tests actually test critical functionality, or only superficial configuration checks?",
  ...
  perspective_user:
    "**As a first-time user:** Can I clone the repo and use it immediately? Is everything documented?",
  perspective_maintainer:
    "**As a maintainer:** Is the code maintainable, understandable, consistent?",
  perspective_security:
    "**As a security reviewer:** Are there open attack vectors, insecure defaults, missing validation?",
  perspective_suffix:
    "Explicitly confirm that nothing can be deleted or damaged. Explicitly confirm no hardcoded secrets or insecure defaults exist.",
...
**System context:** {{system}}</task>`,
  research_tools:
    "**Block A — Tool Evaluation:** What options exist? Benchmark comparison by quality, speed, license, platform support. Known limitations per tool.",
  research_install:
    "**Block B — Installation & Dependencies:** Exact install commands for my system. Known dependency conflicts. CLI syntax and defaults — from CURRENT source code, not outdated documentation.",
  research_platform:
    "**Block C — Platform Issues:** Known bugs on my OS version. Hardware acceleration and compatibility. Memory and performance characteristics.",
  research_automation:
    "**Block D — Automation & Scripting:** Recommended method for non-interactive execution. Backup and rollback strategies. Signal handling for long-running processes.",
  research_security:
    "**Block E — Security:** Known CVEs in current versions. Secure configuration practices.",
  research_suffix:
    "<rules>For each answer: cite sources. When uncertain: describe how I can verify it myself.</rules>",
...
I am providing Deep Research prompt(s) and result report(s), as well as any notes from incomplete reports. Please summarize all findings relevant to the original question as a Markdown document. The summary does not need to be compact — it should contain everything necessary.
  ...
  research_quality_check:
    "Check your summary and all sources again. Is the summary optimal? If there is room for improvement, create a revised version.",
  research_generate_followup:
    "Check whether questions remain open that should be answered. If so, write another Deep Research prompt with enough context — as if nothing is known in advance. Write it as Markdown.",
...
<task>Carefully review the following text:</task>`,
  text_review_facts:
    "Check all facts, numbers, names, and dates for correctness. Mark uncertain items with [VERIFY].",
  text_review_consistency:
    "Are terms used consistently throughout? Are there contradictions between sections?",
  text_review_audience:
    "Are language, level of detail, and tone appropriate for the target audience?",
  text_review_completeness:
    "Are important aspects missing? Are there logical gaps in the argumentation?",
...
const SECTION_LABELS = {
  review_m1: "Control Flow Trace",
  review_m2: "Data Flow Analysis",
  review_m3: "Partial State Analysis",
  review_m4: "Language Standard",
  review_m5: "Quoting / Encoding Audit",
  review_m6: "Platform Audit",
  review_suffix: "Result Format",
  sec_paths: "Path Safety",
  sec_files: "File Safety",
  sec_errors: "Error Handling",
  sec_platform: "Platform Compatibility",
  sec_idempotency: "Idempotency",
  sec_smoke: "Smoke Tests",
  perspective_user: "As First-Time User",
  perspective_maintainer: "As Maintainer",
  perspective_security: "As Security Reviewer",
  perspective_suffix: "Confirmation",
  research_tools: "Tool Evaluation",
  research_install: "Installation & Dependencies",
  research_platform: "Platform Issues",
  research_automation: "Automation & Scripting",
  research_security: "Security",
  research_suffix: "Source Requirements",
  text_review_facts: "Factual Correctness",
  text_review_consistency: "Consistency",
  text_review_audience: "Audience Fit",
  text_review_completeness: "Completeness",
  research_quality_check: "Quality Check",
  research_generate_followup: "Generate Follow-Up",
};

// ── Route Mapping: (type:phase) → config ──
const ROUTES = {
  "script:new": {
    blocks: ["requirements", "prototype", "correction"],
    mods: ["lang_code_en", "priorities"],
  },
  "script:optimize": {
    blocks: ["optimize_script"],
    optMap: {
      readability: "opt_readability",
      simplify: "opt_simplify",
      ux: "opt_ux",
      security: "opt_security",
      structure: "opt_structure",
      performance: "opt_performance",
    },
    mods: [
      "comment_rules",
      "lang_code_en",
  ...
  "script:review": {
    ...
    mods: ["lang_code_en", "no_delete"],
  },
  "script:research": {
    blocks: ["research_consolidated"],
    sections: [
      "research_tools",
      "research_install",
      "research_platform",
  ...
  "repo:review": {
    blocks: ["review_structured", "security_check", "review_perspectives"],
    sections: [
      "review_m1",
      "review_m2",
      "review_m3",
  ...
  "repo:install": {
    blocks: ["install_script"],
    mods: ["lang_code_en", "priorities", "comment_rules"],
  },

  "text:write": { blocks: ["text_write"], mods: [] },
  "text:optimize": {
    blocks: ["text_optimize"],
    optMap: {
      clarity: "opt_text_clarity",
      brevity: "opt_text_brevity",
      tone: "opt_text_tone",
      grammar: "opt_text_grammar",
    },
    mods: [],
  },
  "text:review": {
  ...
  "devops:create": {
    blocks: ["devops_create"],
    mods: ["comment_rules", "priorities", "no_delete"],
  },
  ...
  "devops:migrate": {
    blocks: ["devops_migrate"],
    mods: ["no_delete", "priorities"],
  },
  ...
  "other:optimize": {
    ...
    mods: ["priorities", "implement"],
  },
  "other:review": {
    blocks: ["review_structured"],
    sections: ["review_m1", "review_m2", "review_m3"],
    suffix: "review_suffix",
    mods: ["no_delete"],
  },
  "other:research": {
    blocks: ["research_consolidated"],
    sections: ["research_tools", "research_install", "research_security"],
    suffix: "research_suffix",
    mods: [],
  },
};
